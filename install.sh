...
# =============================================================================
# Install Docker (must happen before secret generation — bcrypt hash needs docker)
# =============================================================================
install_docker
...
# =============================================================================
info "Собираю и запускаю сервисы..."
cd "$SCRIPT_DIR"
...
echo "  3. Запустите ./kuma_config.sh для настройки мониторов"
